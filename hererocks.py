...
hererocks_version = "Hererocks 0.22.0"
__all__ = ["main"]
...
def main(argv=None):
    ...
    parser.add_argument(
        ...
        "Versions 5.1.0 - 5.4.2 are supported. "
        "'latest' and '^' are aliases for 5.4.2. "
    ...
    parser.add_argument(
        ...
        "Version can be specified in the same way as for standard Lua. "
        "Versions 2.0.8 - 3.5.0 are supported. "
        "'latest' and '^' are aliases for 3.5.0. "
